...
type BooleanKey = 'localNotifications' | 'remoteNotifications' | 'telegramScreenshots'
...
const BOOLEAN_KEYS: BooleanKey[] = ['localNotifications', 'remoteNotifications', 'telegramScreenshots']
